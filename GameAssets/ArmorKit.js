...
(function (doomClone) {
    ...
    class ArmorKit extends f.Node {
        ...
        initWall(x, y) {
            ...
            let armorMeshComp = new f.ComponentMesh(new f.MeshCube());
            ...
            let armorMaterial = new f.Material("Armor", f.ShaderUniColor, new f.CoatColored(f.Color.CSS('green')));
            let armorComponentMat = new f.ComponentMaterial(armorMaterial);
            let armorComponentTransform = new f.ComponentTransform(f.Matrix4x4.TRANSLATION(new f.Vector3(x, y, 0)));
